                ...
                <div className="md:w-1/2 relative">
                  <div className="hidden md:block">
                    ...
                    <div
                      ...
                      style={{
                        transform:
                          "rotate(-8deg); z-index: 2; margin-bottom: -220px;",
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        transform:
                          "rotate(-8deg); margin-right: -250px; z-index: 1;",
                      }}
                    >
                      <div
                    ...
                    <div
                      ...
                      style={{
                        transform:
                          "rotate(-8deg); z-index: 1; margin-bottom: -360px;",
                      }}
                    >
