...
import Navbar from "../../components/Navbar/landing-page-2";

export default function landingPage() {
  return (
    <div
      className="px-5 sm:px-32 bg-cover bg-center sm:bg-right"
      style={{
        backgroundImage: "url('/images/landing-page-2/landing.svg')",
      }}
    >
      <div className="h-screen container mx-auto flex flex-col justify-between">
        ...
        <div className="flex justify-center">
          <h1 className="text-4xl sm:text-6xl text-white text-center font-bold leading-none tracking-wide">
            We believe in <span className="text-[#FCAF26]"> Minimalism</span>
          </h1>
        </div>
